...
public class SmosFileTest {
    ...
    public void testCfiToUtc() {
        Date utc = SmosFile.cfiDateToUtc(3456, 2267, 778734);
        assertEquals(1245285467778L, utc.getTime());

        utc = SmosFile.cfiDateToUtc(3457, 2267, 778734);
        assertEquals(1245371867778L, utc.getTime());

        utc = SmosFile.cfiDateToUtc(3456, 2268, 778734);
        assertEquals(1245285468778L, utc.getTime());

        utc = SmosFile.cfiDateToUtc(3456, 2267, 878734);
