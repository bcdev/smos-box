...
public class LaiFileTest {
    ...
    public void testZoneDataSizes() throws IOException {
        if (HDR_FILE.exists() && DBL_FILE.exists()) {
            final DataFormat dataFormat = Dddb.getInstance().getDataFormat(HDR_FILE);
            final LaiFile laiFile = new LaiFile(HDR_FILE, DBL_FILE, dataFormat.createContext(DBL_FILE, "r"));
    ...
    public static void main(String[] args) throws IOException {
        final DataFormat dataFormat = Dddb.getInstance().getDataFormat(HDR_FILE);
        final ExplorerFile explorerFile = new LaiFile(HDR_FILE, DBL_FILE, dataFormat.createContext(DBL_FILE, "r"));
